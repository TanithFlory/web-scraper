...
function NavigationItem({ icon, text }: NavigationItemProps) {
  return (
    <div className="flex items-center gap-2 hover:bg-[#eeeeee] p-2 rounded-sm cursor-pointer">
      <div>{icon}</div>
      <div>{text}</div>
    </div>
  );
...
export default function Page() {
  ...
  return (
    <section>
      <Wrapper>
        <div className="bg-white rounded-md h-[500px] flex">
          <div className="w-[240px] border-r-2 border-[#E8E8E8] p-4">
